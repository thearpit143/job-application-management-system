...
const ViewCandidate = () => {
  ...
  const handleApprove = async () => {
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/candidates/${candidate.id}/approve`, { method: "POST" });
  ...
  const handleReject = async () => {
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/candidates/${candidate.id}/reject`, { method: "POST" });
      const data = await res.json();
  ...
  const handleViewResume = () => {
    window.open(`${API_BASE_URL}/api/candidates/${candidate.id}/resume`, '_blank');
  };
